...
{
	struct Task *vLeft = (struct Task*) left;
	struct Task *vRight = (struct Task*) right;

	if( vLeft->priority < vRight->priority){
	//	printf(" -1 Left is:"); print_type(left);
	//	printf(" -1 Right is:");print_type(right);
		return -1;
	}else if(vLeft->priority == vRight->priority){
        //      printf("1 Left is:");print_type(left);
        //      printf("1 Right is");print_type(right);
		return 0;
	}else{
