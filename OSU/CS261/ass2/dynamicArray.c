...
void addDynArr(DynArr *v, TYPE val)
{
	if(v->size == v->capacity-1){
		//printf("The capacity of the array has been reached, setting new array capacity to be %d!\n", struct v->capacity*2);
...
int containsDynArr(DynArr *v, TYPE val)
{
	...
	//0 is returned if values does not exist
	return 0;
